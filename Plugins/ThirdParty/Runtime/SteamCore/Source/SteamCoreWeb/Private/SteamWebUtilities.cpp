...
void USteamWebUtilities::FindJsonBools(const FString& JsonString, const FString& Key, TArray<bool>& Values, ESteamJsonResult& Result) {
}

void USteamWebUtilities::FindJsonBool(const FString& JsonString, const FString& Key, bool& Value, ESteamJsonResult& Result) {
}
