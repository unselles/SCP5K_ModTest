...
void UWebRemoteStorage::UnsubscribePublishedFile(const FOnSteamCoreWebCallback& Callback, const FString& Key, const FString& SteamID, int32 AppID, const FString& PublishedFileID) {
}

void UWebRemoteStorage::SubscribePublishedFile(const FOnSteamCoreWebCallback& Callback, const FString& Key, const FString& SteamID, int32 AppID, const FString& PublishedFileID) {
}
...
void UWebRemoteStorage::GetPublishedFileDetails(const FOnSteamCoreWebCallback& Callback, const FString& PublishedFileID) {
}
