...
public:
    ...
    void UnsubscribePublishedFile(const FOnSteamCoreWebCallback& Callback, const FString& Key, const FString& SteamID, int32 AppID, const FString& PublishedFileID);
    
    UFUNCTION(BlueprintCallable)
    void SubscribePublishedFile(const FOnSteamCoreWebCallback& Callback, const FString& Key, const FString& SteamID, int32 AppID, const FString& PublishedFileID);
    ...
    UFUNCTION(BlueprintCallable)
    void GetPublishedFileDetails(const FOnSteamCoreWebCallback& Callback, const FString& PublishedFileID);
