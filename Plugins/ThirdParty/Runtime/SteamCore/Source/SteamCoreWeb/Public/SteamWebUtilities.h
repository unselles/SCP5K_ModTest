...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void FindJsonBools(const FString& JsonString, const FString& Key, TArray<bool>& Values, ESteamJsonResult& Result);
    
    UFUNCTION(BlueprintCallable)
    static void FindJsonBool(const FString& JsonString, const FString& Key, bool& Value, ESteamJsonResult& Result);
