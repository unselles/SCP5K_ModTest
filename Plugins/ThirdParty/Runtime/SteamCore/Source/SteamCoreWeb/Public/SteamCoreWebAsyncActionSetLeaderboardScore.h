...
public:
    ...
    static USteamCoreWebAsyncActionSetLeaderboardScore* SetLeaderboardScoreAsync(UObject* WorldContextObject, const FString& Key, int32 AppID, int32 leaderbordID, const FString& SteamID, int32 Score, TArray<uint8> Details, const FString& scoreMethod);
